...
- Source of truth: [`.github/skills/dibs/scripts/dibs.py`](./skills/dibs/scripts/dibs.py) — stdlib-only Python, nothing to install.
- Full coordination contract (claim, heartbeat, reserve, handoff, complete/block/cancel): [`.github/skills/dibs/SKILL.md`](./skills/dibs/SKILL.md). Read it before claiming or completing a task.
